  ...
  <section class="space-y-6 animate-fade-in">
    ...
    <div v-if="activeTab === 'add-group'" class="space-y-6">
      <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6">
          <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-medium text-neutral-900">Multifactor</h3>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <i class="fas fa-search text-neutral-400"></i>
              </div>
    ...
    <div v-if="activeTab === 'owned-groups'" class="space-y-6">
      <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6">
          <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-medium text-neutral-900">IP Whitelisting</h3>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <i class="fas fa-search text-neutral-400"></i>
              </div>
...
export default {
  ...
  setup() {
    ...
    const groupTabs = [
      { id: 'group-list', label: 'Password Policy' },
      { id: 'add-group', label: 'Multi-factor Auth' },
      { id: 'owned-groups', label: 'IP Whitelisting' },
      { id: 'member-groups', label: 'Session Management' },
      { id: 'deleted-groups', label: 'Lock Settings' }
    ]
